        ...
        footer={
          belumDibaca > 0 ? (
            <button
              type="button"
              onClick={tandaiSemua}
              className="sentuh-nyaman tekan-halus h-10 rounded-lg border border-outline-variant px-4 font-label-md text-label-md text-on-surface hover:bg-surface-container-low focus-visible:outline-none focus-visible:ring-3 focus-visible:ring-primary/50"
            >
              Tandai semua dibaca
            </button>
          ) : undefined

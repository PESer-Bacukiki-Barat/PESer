 ...
 * di header". Mengetuknya membuka rincian antrean beserta aksinya.
 */
export function BadgeAntrean() {
  ...
  // Saat online dan antrean kosong, tidak ada yang perlu diberitahukan.
  ...
  return (
    <>
      ...
      >
        {online ? <CloudOff className="size-4" aria-hidden /> : <WifiOff className="size-4" aria-hidden />}
 ...
 * tertunda". Antrean tersimpan di IndexedDB per perangkat, jadi keluar tanpa
 * mengirim berarti setoran itu menggantung sampai orang yang sama login lagi
...
export function TombolKeluar() {
  ...
  return (
    <>
      ...
      {/*
        Memakai Modal, bukan ConfirmDialog: ConfirmDialog mengunci teks
        "Tindakan ini tidak dapat dibatalkan", sedangkan keluar justru bisa
        dibatalkan dengan login kembali. Yang tidak bisa dibatalkan adalah
        kehilangan antreannya kalau perangkat ini berpindah tangan.
      */}
      <Modal
        open={konfirmasi}

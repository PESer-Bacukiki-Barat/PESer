...
import { EditPetugasModal } from "@/components/admin/petugas-edit-modal";
import { UNIT_KERJA, type Petugas, type PetugasStatus } from "@/lib/petugas-data";

export type { Petugas, PetugasStatus } from "@/lib/petugas-data";

const STATUS_STYLES: Record<PetugasStatus, string> = {
  Aktif: "bg-primary-container text-on-primary-container border border-primary-fixed-dim",
